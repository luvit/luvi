...
SET(LUAJIT_DIR ${CMAKE_SOURCE_DIR}/luajit-2.0)
...
FILE(GLOB jit_files ${CMAKE_SOURCE_DIR}/luajit-2.0/src/jit/*.lua)
...
IF(WITH_AMALG)
  add_library(libluajit STATIC ${LUAJIT_DIR}/src/ljamalg.c ${DEPS} )
ELSE()
  add_library(libluajit STATIC ${SRC_LJCORE} ${DEPS} )
ENDIF()
